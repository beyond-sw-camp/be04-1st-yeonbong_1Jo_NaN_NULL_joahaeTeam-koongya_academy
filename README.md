...
```sql
    ...
    (
     ...
     COMMENT '아이디',
        ...
        `name`    VARCHAR(255) NOT NULL COMMENT '강사이름',
        `phone`    VARCHAR(255) NOT NULL COMMENT '강사연락처',
        `address`    VARCHAR(255) NOT NULL COMMENT '강사주소',
        `pic`    MEDIUMBLOB NOT NULL COMMENT '강사사진',
        `enroll_date`    DATE NOT NULL COMMENT '강사등록일',
        `resign_date`    DATE COMMENT '강사퇴사일',
        `status`    CHAR(1) NOT NULL COMMENT '강사재직여부',
        `email`    VARCHAR(255) NOT NULL COMMENT '강사이메일',
        `salary`    INT NOT NULL COMMENT '강사급여정보',
